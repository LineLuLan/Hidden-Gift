...
export default async function SecretsPage() {
      ...
      <div className="mx-auto max-w-2xl space-y-6">
        <header className="space-y-1.5">
          ...
          <p className="text-muted-foreground text-sm">
            Chuẩn bị quà bí mật cho thành viên trong nhóm — ẩn tuyệt đối ở tầng database.
          </p>
        </header>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tính năng Bí mật cần có người để tặng. Tạo mã mời ở Cài đặt và gửi cho người ấy để hai
              bạn cùng dùng.
            </CardDescription>
          </CardHeader>
          <CardContent>
  ...
  const isSquadOrFamily = detail.kind === "squad" || detail.kind === "family";
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <SecretList
        ...
        secrets={secrets}
        isSquadOrFamily={isSquadOrFamily}
      />
    </div>
  );
}
